...
class ConsoleAdminApi
{
    ...
    protected function activateDeploymentRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/activateDeployment/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function adaptGameVersionRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/adaptGameVersion/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addGameToProjectRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/addGameToProject/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createGameRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/createGame/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function createProjectRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/createProject/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteGameRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/deleteGame/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteGameVersionRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/deleteGameVersion/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteProjectRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/deleteProject/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getGameVersionRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/getGameVersion/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getGameVersionProgressRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/getGameVersionProgress/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function listActivateableInstancesRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/listActivateableInstances/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function listActivatedInstancesRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/listActivatedInstances/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function listControllersOfGameRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/listControllersOfGame/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function listDeployableInstancesRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/listDeployableInstances/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function listGameVersionsRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/listGameVersions/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function listGamesRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/listGames/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function listProjectsRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/listProjects/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function removeGameFromProjectRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/removeGameFromProject/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function submitDeploymentRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/submitDeployment/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function uploadGameVersionByDownloadRequest($varForms)
    {
        ...
        $resourcePath = '/consoleAdmin/uploadGameVersionByDownload/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
