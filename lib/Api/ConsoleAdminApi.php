...
class ConsoleAdminApi
{
     ...
     *
     * @param  \Yjopenapi\Client\Model\ConsoleAdminGetGameInstanceContainerRatioForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\ConsoleAdminGetGameInstanceContainerRatioResult
     */
     ...
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\ConsoleAdminGetGameInstanceContainerRatioResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getGameInstanceContainerRatioWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\ConsoleAdminGetGameInstanceContainerRatioResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\ConsoleAdminGetGameInstanceContainerRatioResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Yjopenapi\Client\Model\ConsoleAdminGetGameRecommendedInstanceForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\ConsoleAdminGetGameRecommendedInstanceResult
     */
     ...
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\ConsoleAdminGetGameRecommendedInstanceResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getGameRecommendedInstanceWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\ConsoleAdminGetGameRecommendedInstanceResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\ConsoleAdminGetGameRecommendedInstanceResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Yjopenapi\Client\Model\ConsoleAdminListGameCcuForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\ConsoleAdminListGameCcuResult
     */
     ...
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\ConsoleAdminListGameCcuResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function listGameCcuWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\ConsoleAdminListGameCcuResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\ConsoleAdminListGameCcuResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Yjopenapi\Client\Model\ConsoleAdminRtOverViewForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\ConsoleAdminRtOverViewResult
     */
     ...
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\ConsoleAdminRtOverViewResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function rtOverViewWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\ConsoleAdminRtOverViewResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\ConsoleAdminRtOverViewResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Operation rtTrend
     *
     * @param  \Yjopenapi\Client\Model\ConsoleAdminRtTrendForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\ConsoleAdminRtTrendResult
     */
     ...
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\ConsoleAdminRtTrendResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function rtTrendWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\ConsoleAdminRtTrendResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\ConsoleAdminRtTrendResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Yjopenapi\Client\Model\ConsoleAdminSubmitRefundForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\ConsoleAdminSubmitRefundResult
     */
     ...
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\ConsoleAdminSubmitRefundResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitRefundWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\ConsoleAdminSubmitRefundResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\ConsoleAdminSubmitRefundResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
