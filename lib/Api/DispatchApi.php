...
class DispatchApi
{
    ...
    protected function cancelGameHangRequest($varForms)
    {
        ...
        $resourcePath = '/cancelGameHang/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getGameConcurrencyRequest($varForms)
    {
        ...
        $resourcePath = '/getGameConcurrency/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getStopGameTokenRequest($varForms)
    {
        ...
        $resourcePath = '/getStopGameToken/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function listGameServerIpRequest($varForms)
    {
        ...
        $resourcePath = '/listGameServerIp/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function querySessionStatusRequest($varForms)
    {
        ...
        $resourcePath = '/querySessionStatus/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
