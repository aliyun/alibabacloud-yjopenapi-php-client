...
class DispatchApi
{
     ...
     *
     * @param  \Yjopenapi\Client\Model\ClientNotifyForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\ClientNotifyResult
     */
     ...
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\ClientNotifyResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function clientNotifyWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\ClientNotifyResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\ClientNotifyResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Yjopenapi\Client\Model\ReplaceSlotForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\ReplaceSlotResult
     */
     ...
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\ReplaceSlotResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function replaceSlotWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\ReplaceSlotResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\ReplaceSlotResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Yjopenapi\Client\Model\TryToGetSlotsForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\TryToGetSlotsResult
     */
     ...
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\TryToGetSlotsResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function tryToGetSlotsWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\TryToGetSlotsResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\TryToGetSlotsResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Yjopenapi\Client\Model\UpdatePreopenStrategyForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\UpdatePreopenStrategyResult
     */
     ...
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\UpdatePreopenStrategyResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePreopenStrategyWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\UpdatePreopenStrategyResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\UpdatePreopenStrategyResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
