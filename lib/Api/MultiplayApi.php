...
class MultiplayApi
{
    ...
    protected function closeRequest($varForms)
    {
        ...
        $resourcePath = '/multiplay/close/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation demoCloseMultiPlay
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoCloseMultiPlayForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\MultiplayDemoCloseMultiPlayResult
     */
    public function demoCloseMultiPlay($varForms)
    {
        list($response) = $this->demoCloseMultiPlayWithHttpInfo($varForms);
        return $response;
    }

    /**
     * Operation demoCloseMultiPlayWithHttpInfo
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoCloseMultiPlayForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\MultiplayDemoCloseMultiPlayResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function demoCloseMultiPlayWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\MultiplayDemoCloseMultiPlayResult';
        $request = $this->demoCloseMultiPlayRequest($varForms);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\MultiplayDemoCloseMultiPlayResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation demoCloseMultiPlayAsync
     *
     * 
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoCloseMultiPlayForms $varForms
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function demoCloseMultiPlayAsync($varForms)
    {
        return $this->demoCloseMultiPlayAsyncWithHttpInfo($varForms)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation demoCloseMultiPlayAsyncWithHttpInfo
     *
     * 
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoCloseMultiPlayForms $varForms
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function demoCloseMultiPlayAsyncWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\MultiplayDemoCloseMultiPlayResult';
        $request = $this->demoCloseMultiPlayRequest($varForms);
    ...
    /**
     * Create request for operation 'demoCloseMultiPlay'
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoCloseMultiPlayForms $varForms
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function demoCloseMultiPlayRequest($varForms)
    {

        $resourcePath = '/multiplay/demoCloseMultiPlay';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // form params
        if ($varForms['mp_id'] !== null) {
            $formParams['mpId'] = ObjectSerializer::toFormValue($varForms['mp_id']);
        }
        if ($varForms['reason'] !== null) {
            $formParams['reason'] = ObjectSerializer::toFormValue($varForms['reason']);
        }
        if ($varForms['open_ak'] !== null) {
            $formParams['openAk'] = ObjectSerializer::toFormValue($varForms['open_ak']);
        }
        if ($varForms['open_sk'] !== null) {
            $formParams['openSk'] = ObjectSerializer::toFormValue($varForms['open_sk']);
        }
    ...
    /**
     * Operation demoInitMultiPlay
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoInitMultiPlayForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\MultiplayDemoInitMultiPlayResult
     */
    public function demoInitMultiPlay($varForms)
    {
        list($response) = $this->demoInitMultiPlayWithHttpInfo($varForms);
        return $response;
    }

    /**
     * Operation demoInitMultiPlayWithHttpInfo
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoInitMultiPlayForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\MultiplayDemoInitMultiPlayResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function demoInitMultiPlayWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\MultiplayDemoInitMultiPlayResult';
        $request = $this->demoInitMultiPlayRequest($varForms);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\MultiplayDemoInitMultiPlayResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation demoInitMultiPlayAsync
     *
     * 
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoInitMultiPlayForms $varForms
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function demoInitMultiPlayAsync($varForms)
    {
        return $this->demoInitMultiPlayAsyncWithHttpInfo($varForms)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation demoInitMultiPlayAsyncWithHttpInfo
     *
     * 
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoInitMultiPlayForms $varForms
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function demoInitMultiPlayAsyncWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\MultiplayDemoInitMultiPlayResult';
        $request = $this->demoInitMultiPlayRequest($varForms);
    ...
    /**
     * Create request for operation 'demoInitMultiPlay'
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoInitMultiPlayForms $varForms
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function demoInitMultiPlayRequest($varForms)
    {

        $resourcePath = '/multiplay/demoInitMultiPlay';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($varForms['scheduler_config'] !== null) {
            $formParams['schedulerConfig'] = ObjectSerializer::toFormValue($varForms['scheduler_config']);
        }
    ...
    /**
     * Operation demoJoinMultiPlay
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoJoinMultiPlayForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\MultiplayDemoJoinMultiPlayResult
     */
    public function demoJoinMultiPlay($varForms)
    {
        list($response) = $this->demoJoinMultiPlayWithHttpInfo($varForms);
        return $response;
    }

    /**
     * Operation demoJoinMultiPlayWithHttpInfo
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoJoinMultiPlayForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\MultiplayDemoJoinMultiPlayResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function demoJoinMultiPlayWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\MultiplayDemoJoinMultiPlayResult';
        $request = $this->demoJoinMultiPlayRequest($varForms);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\MultiplayDemoJoinMultiPlayResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation demoJoinMultiPlayAsync
     *
     * 
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoJoinMultiPlayForms $varForms
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function demoJoinMultiPlayAsync($varForms)
    {
        return $this->demoJoinMultiPlayAsyncWithHttpInfo($varForms)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation demoJoinMultiPlayAsyncWithHttpInfo
     *
     * 
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoJoinMultiPlayForms $varForms
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function demoJoinMultiPlayAsyncWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\MultiplayDemoJoinMultiPlayResult';
        $request = $this->demoJoinMultiPlayRequest($varForms);
    ...
    /**
     * Create request for operation 'demoJoinMultiPlay'
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoJoinMultiPlayForms $varForms
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function demoJoinMultiPlayRequest($varForms)
    {

        $resourcePath = '/multiplay/demoJoinMultiPlay';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation demoLeaveMultiPlay
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoLeaveMultiPlayForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\MultiplayDemoLeaveMultiPlayResult
     */
    public function demoLeaveMultiPlay($varForms)
    {
        list($response) = $this->demoLeaveMultiPlayWithHttpInfo($varForms);
        return $response;
    }

    /**
     * Operation demoLeaveMultiPlayWithHttpInfo
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoLeaveMultiPlayForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\MultiplayDemoLeaveMultiPlayResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function demoLeaveMultiPlayWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\MultiplayDemoLeaveMultiPlayResult';
        $request = $this->demoLeaveMultiPlayRequest($varForms);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\MultiplayDemoLeaveMultiPlayResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation demoLeaveMultiPlayAsync
     *
     * 
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoLeaveMultiPlayForms $varForms
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function demoLeaveMultiPlayAsync($varForms)
    {
        return $this->demoLeaveMultiPlayAsyncWithHttpInfo($varForms)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation demoLeaveMultiPlayAsyncWithHttpInfo
     *
     * 
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoLeaveMultiPlayForms $varForms
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function demoLeaveMultiPlayAsyncWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\MultiplayDemoLeaveMultiPlayResult';
        $request = $this->demoLeaveMultiPlayRequest($varForms);
    ...
    /**
     * Create request for operation 'demoLeaveMultiPlay'
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoLeaveMultiPlayForms $varForms
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function demoLeaveMultiPlayRequest($varForms)
    {

        $resourcePath = '/multiplay/demoLeaveMultiPlay';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation demoModifyMultiPlay
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoModifyMultiPlayForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\MultiplayDemoModifyMultiPlayResult
     */
    public function demoModifyMultiPlay($varForms)
    {
        list($response) = $this->demoModifyMultiPlayWithHttpInfo($varForms);
        return $response;
    }

    /**
     * Operation demoModifyMultiPlayWithHttpInfo
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoModifyMultiPlayForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\MultiplayDemoModifyMultiPlayResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function demoModifyMultiPlayWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\MultiplayDemoModifyMultiPlayResult';
        $request = $this->demoModifyMultiPlayRequest($varForms);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\MultiplayDemoModifyMultiPlayResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation demoModifyMultiPlayAsync
     *
     * 
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoModifyMultiPlayForms $varForms
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function demoModifyMultiPlayAsync($varForms)
    {
        return $this->demoModifyMultiPlayAsyncWithHttpInfo($varForms)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation demoModifyMultiPlayAsyncWithHttpInfo
     *
     * 
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoModifyMultiPlayForms $varForms
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function demoModifyMultiPlayAsyncWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\MultiplayDemoModifyMultiPlayResult';
        $request = $this->demoModifyMultiPlayRequest($varForms);
    ...
    /**
     * Create request for operation 'demoModifyMultiPlay'
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoModifyMultiPlayForms $varForms
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function demoModifyMultiPlayRequest($varForms)
    {

        $resourcePath = '/multiplay/demoModifyMultiPlay';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation demoQueryMultiPlay
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoQueryMultiPlayForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Model\MultiplayDemoQueryMultiPlayResult
     */
    public function demoQueryMultiPlay($varForms)
    {
        list($response) = $this->demoQueryMultiPlayWithHttpInfo($varForms);
        return $response;
    }

    /**
     * Operation demoQueryMultiPlayWithHttpInfo
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoQueryMultiPlayForms $varForms
     *
     * @throws \Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Model\MultiplayDemoQueryMultiPlayResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function demoQueryMultiPlayWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\MultiplayDemoQueryMultiPlayResult';
        $request = $this->demoQueryMultiPlayRequest($varForms);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Model\MultiplayDemoQueryMultiPlayResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation demoQueryMultiPlayAsync
     *
     * 
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoQueryMultiPlayForms $varForms
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function demoQueryMultiPlayAsync($varForms)
    {
        return $this->demoQueryMultiPlayAsyncWithHttpInfo($varForms)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation demoQueryMultiPlayAsyncWithHttpInfo
     *
     * 
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoQueryMultiPlayForms $varForms
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function demoQueryMultiPlayAsyncWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Model\MultiplayDemoQueryMultiPlayResult';
        $request = $this->demoQueryMultiPlayRequest($varForms);
    ...
    /**
     * Create request for operation 'demoQueryMultiPlay'
     *
     * @param  \Yjopenapi\Client\Model\MultiplayDemoQueryMultiPlayForms $varForms
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function demoQueryMultiPlayRequest($varForms)
    {

        $resourcePath = '/multiplay/demoQueryMultiPlay';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function initRequest($varForms)
    {
        ...
        $resourcePath = '/multiplay/init/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function joinRequest($varForms)
    {
        ...
        $resourcePath = '/multiplay/join/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function leaveRequest($varForms)
    {
        ...
        $resourcePath = '/multiplay/leave/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function modifyRequest($varForms)
    {
        ...
        $resourcePath = '/multiplay/modify/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function queryRequest($varForms)
    {
        ...
        $resourcePath = '/multiplay/query/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
