...
class MultiplayApi
{
     ...
     * Operation close
     *
     * @param  \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayCloseForms $varForms
     *
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayCloseResult
     */
     ...
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayCloseResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function closeWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayCloseResult';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayCloseResult',
     ...
     * Operation init
     *
     * @param  \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayInitForms $varForms
     *
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayInitResult
     */
     ...
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayInitResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function initWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayInitResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayInitResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Operation join
     *
     * @param  \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayJoinForms $varForms
     *
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayJoinResult
     */
     ...
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayJoinResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function joinWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayJoinResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayJoinResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Operation leave
     *
     * @param  \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayLeaveForms $varForms
     *
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayLeaveResult
     */
     ...
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayLeaveResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function leaveWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayLeaveResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayLeaveResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Operation modify
     *
     * @param  \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayModifyForms $varForms
     *
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayModifyResult
     */
     ...
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayModifyResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayModifyResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayModifyResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Operation query
     *
     * @param  \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayQueryForms $varForms
     *
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayQueryResult
     */
     ...
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayQueryResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($varForms)
    {
        $returnType = '\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayQueryResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayQueryResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
