...
class TokenApi
{
     ...
     * @return \Yjopenapi\Client\Yjopenapi\Client\Model\GetPairResult
     */
     ...
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Yjopenapi\Client\Model\GetPairResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPairWithHttpInfo()
    {
        $returnType = '\Yjopenapi\Client\Yjopenapi\Client\Model\GetPairResult';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Yjopenapi\Client\Model\GetPairResult',
     ...
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Yjopenapi\Client\Yjopenapi\Client\Model\GetTripleResult
     */
     ...
     * @throws \Yjopenapi\Client\Yjopenapi\Client\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Yjopenapi\Client\Yjopenapi\Client\Model\GetTripleResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTripleWithHttpInfo()
    {
        $returnType = '\Yjopenapi\Client\Yjopenapi\Client\Model\GetTripleResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Yjopenapi\Client\Yjopenapi\Client\Model\GetTripleResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
