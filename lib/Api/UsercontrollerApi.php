...
class UsercontrollerApi
{
    ...
    protected function deleteGameArchiveRequest($varForms)
    {
        ...
        $resourcePath = '/usercontroller/deleteGameArchive/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getGameTrialSurplusDurationRequest($varForms)
    {
        ...
        $resourcePath = '/usercontroller/getGameTrialSurplusDuration/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getUserGameArchiveRequest($varForms)
    {
        ...
        $resourcePath = '/usercontroller/getUserGameArchive/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function listLatestGameArchiveRequest($varForms)
    {
        ...
        $resourcePath = '/usercontroller/listLatestGameArchive/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function restoreGameArchiveRequest($varForms)
    {
        ...
        $resourcePath = '/usercontroller/restoreGameArchive/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateGameArchiveTagStatusRequest($varForms)
    {
        ...
        $resourcePath = '/usercontroller/updateGameArchiveTagStatus/v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
