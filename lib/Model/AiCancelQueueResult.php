...
class AiCancelQueueResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $serialTypes = [
        'success' => 'bool',
'model' => '\Yjopenapi\Client\Model\AiCancelQueueResultModel',
'msg_info' => 'string',
'msg_code' => 'string'    ];
...
'msg_code' => 'getMsgCode'    ];
     ...
     * Gets model
     *
     * @return \Yjopenapi\Client\Model\AiCancelQueueResultModel
     */
     ...
     * Sets model
     *
     * @param \Yjopenapi\Client\Model\AiCancelQueueResultModel $model model
     *
     * @return $this
     */
