...
class AiGetPromptResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $serialTypes = [
        'success' => 'bool',
'model' => '\Yjopenapi\Client\Model\AiGetPromptResultModel',
'msg_info' => 'string',
'msg_code' => 'string'    ];
...
'msg_code' => 'getMsgCode'    ];
     ...
     * Gets model
     *
     * @return \Yjopenapi\Client\Model\AiGetPromptResultModel
     */
     ...
     * Sets model
     *
     * @param \Yjopenapi\Client\Model\AiGetPromptResultModel $model model
     *
     * @return $this
     */
