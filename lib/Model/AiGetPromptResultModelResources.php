...
/**
 * AiGetPromptResultModelResources Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class AiGetPromptResultModelResources implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'AiGetPromptResultModelResources';
