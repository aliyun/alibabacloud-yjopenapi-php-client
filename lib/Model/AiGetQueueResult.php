...
class AiGetQueueResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $serialTypes = [
        'success' => 'bool',
'model' => '\Yjopenapi\Client\Model\AiGetQueueResultModel',
'msg_info' => 'string',
'msg_code' => 'string'    ];
...
'msg_code' => 'getMsgCode'    ];
     ...
     * Gets model
     *
     * @return \Yjopenapi\Client\Model\AiGetQueueResultModel
     */
     ...
     * Sets model
     *
     * @param \Yjopenapi\Client\Model\AiGetQueueResultModel $model model
     *
     * @return $this
     */
