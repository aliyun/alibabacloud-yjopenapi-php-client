...
/**
 * AiUpdateNpcRoleFormsKnowledgeBases Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class AiUpdateNpcRoleFormsKnowledgeBases implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'AiUpdateNpcRoleFormsKnowledgeBases';
