...
/**
 * ConsoleAdminCreateOrderFormsAttributeRequestList Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class ConsoleAdminCreateOrderFormsAttributeRequestList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'ConsoleAdminCreateOrderFormsAttributeRequestList';
...
'time_unit' => 'getTimeUnit'    ];
     ...
     * Sets attribute_code
     *
     * @param string $attribute_code 属性编码
     *
     * @return $this
     */
     ...
     *
     * @param int $attribute_value 属性值(区间型专用)
     *
     * @return $this
     */
     ...
     *
     * @param int $attribute_value_code 属性值编码(枚举型，时长型 专用)
     *
     * @return $this
     */
