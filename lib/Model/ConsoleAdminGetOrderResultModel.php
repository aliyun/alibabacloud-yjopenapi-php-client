...
class ConsoleAdminGetOrderResultModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $serialTypes = [
        'order_type' => 'string',
'order_id' => 'string',
'attribute_list' => '\Yjopenapi\Client\Model\ConsoleAdminGetOrderResultModelAttributeList[]',
'charge_type' => 'string',
'discount_amount' => 'int',
...
'status' => 'getStatus'    ];
     ...
     * Gets attribute_list
     *
     * @return \Yjopenapi\Client\Model\ConsoleAdminGetOrderResultModelAttributeList[]
     */
     ...
     * Sets attribute_list
     *
     * @param \Yjopenapi\Client\Model\ConsoleAdminGetOrderResultModelAttributeList[] $attribute_list 配置详情
     *
     * @return $this
     */
