...
'data_list' => 'getDataList'    ];
     ...
     * Sets total_count
     *
     * @param int $total_count 本次请求条件下的数据总量
     *
     * @return $this
     */
     ...
     * Sets page_number
     *
     * @param int $page_number 表示当前调用返回读取到的位置
     *
     * @return $this
     */
     ...
     * Sets page_size
     *
     * @param int $page_size 本次请求所返回的最大记录条数
     *
     * @return $this
     */
     ...
     * Sets data_list
     *
     * @param \Yjopenapi\Client\Model\ConsoleAdminListDeployableInstancesResultModelDataList[] $data_list 数据列表
     *
     * @return $this
     */
