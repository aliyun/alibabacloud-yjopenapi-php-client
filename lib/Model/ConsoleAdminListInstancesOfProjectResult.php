...
class ConsoleAdminListInstancesOfProjectResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $serialTypes = [
        'success' => 'string',
'model' => '\Yjopenapi\Client\Model\ConsoleAdminListInstancesOfProjectResultModel',
'msg_info' => 'string',
'msg_code' => 'string'    ];
...
'msg_code' => 'getMsgCode'    ];
     ...
     * Gets model
     *
     * @return \Yjopenapi\Client\Model\ConsoleAdminListInstancesOfProjectResultModel
     */
     ...
     * Sets model
     *
     * @param \Yjopenapi\Client\Model\ConsoleAdminListInstancesOfProjectResultModel $model model
     *
     * @return $this
     */
