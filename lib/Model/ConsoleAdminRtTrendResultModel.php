...
class ConsoleAdminRtTrendResultModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $serialTypes = [
        'data' => '\Yjopenapi\Client\Model\ConsoleAdminRtTrendResultModelData[]',
'max_value' => 'string'    ];
...
'max_value' => 'getMaxValue'    ];
     ...
     * Gets data
     *
     * @return \Yjopenapi\Client\Model\ConsoleAdminRtTrendResultModelData[]
     */
     ...
     * Sets data
     *
     * @param \Yjopenapi\Client\Model\ConsoleAdminRtTrendResultModelData[] $data data
     *
     * @return $this
     */
