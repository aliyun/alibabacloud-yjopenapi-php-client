...
class ConsoleAdminRtTrendResultModelData implements ModelInterface, ArrayAccess
{
    ...
    protected static $serialTypes = [
        'data' => '\Yjopenapi\Client\Model\ConsoleAdminRtTrendResultModelDataData[]',
...
'name' => 'getName'    ];
     ...
     * Gets data
     *
     * @return \Yjopenapi\Client\Model\ConsoleAdminRtTrendResultModelDataData[]
     */
     ...
     * Sets data
     *
     * @param \Yjopenapi\Client\Model\ConsoleAdminRtTrendResultModelDataData[] $data data
     *
     * @return $this
     */
