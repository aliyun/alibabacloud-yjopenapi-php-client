<?php
/**
 * GetStockResultInstanceStockList
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GetStockResultInstanceStockList Class Doc Comment
 *
 * @category Class
 * @description 实例库存信息
 * @package  Yjopenapi\Client
 */
class GetStockResultInstanceStockList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'GetStockResultInstanceStockList';
