...
/**
 * InteractiveGetPartyResult Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class InteractiveGetPartyResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'InteractiveGetPartyResult';
    ...
    protected static $serialTypes = [
        'msg_code' => 'string',
'msg_info' => 'string',
'model' => '\Yjopenapi\Client\Model\InteractiveGetPartyResultModel'    ];
...
'model' => 'getModel'    ];
     ...
     * Gets model
     *
     * @return \Yjopenapi\Client\Model\InteractiveGetPartyResultModel
     */
     ...
     * Sets model
     *
     * @param \Yjopenapi\Client\Model\InteractiveGetPartyResultModel $model model
     *
     * @return $this
     */
