<?php
/**
 * InteractiveGetPartyResultModel
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * InteractiveGetPartyResultModel Class Doc Comment
 *
 * @category Class
 * @description 获取结果
 * @package  Yjopenapi\Client
 */
class InteractiveGetPartyResultModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'InteractiveGetPartyResultModel';
