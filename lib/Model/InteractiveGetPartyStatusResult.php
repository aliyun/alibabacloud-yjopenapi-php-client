...
/**
 * InteractiveGetPartyStatusResult Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class InteractiveGetPartyStatusResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'InteractiveGetPartyStatusResult';
    ...
    protected static $serialTypes = [
        'msg_code' => 'string',
'msg_info' => 'string',
'model' => '\Yjopenapi\Client\Model\InteractiveGetPartyStatusResultModel'    ];
...
'model' => 'getModel'    ];
     ...
     * Gets model
     *
     * @return \Yjopenapi\Client\Model\InteractiveGetPartyStatusResultModel
     */
     ...
     * Sets model
     *
     * @param \Yjopenapi\Client\Model\InteractiveGetPartyStatusResultModel $model model
     *
     * @return $this
     */
