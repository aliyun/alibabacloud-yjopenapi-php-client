...
/**
 * InteractiveGetPartyStatusResultModelPlayList Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class InteractiveGetPartyStatusResultModelPlayList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'InteractiveGetPartyStatusResultModelPlayList';
