...
/**
 * InteractiveJoinPartyResult Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class InteractiveJoinPartyResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'InteractiveJoinPartyResult';
    ...
    protected static $serialTypes = [
        'msg_code' => 'string',
'msg_info' => 'string',
'model' => '\Yjopenapi\Client\Model\InteractiveJoinPartyResultModel'    ];
...
'model' => 'getModel'    ];
     ...
     * Gets model
     *
     * @return \Yjopenapi\Client\Model\InteractiveJoinPartyResultModel
     */
     ...
     * Sets model
     *
     * @param \Yjopenapi\Client\Model\InteractiveJoinPartyResultModel $model model
     *
     * @return $this
     */
