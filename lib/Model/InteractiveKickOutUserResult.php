...
/**
 * InteractiveKickOutUserResult Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class InteractiveKickOutUserResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'InteractiveKickOutUserResult';
    ...
    protected static $serialTypes = [
        'msg_code' => 'string',
'msg_info' => 'string',
'model' => '\Yjopenapi\Client\Model\InteractiveKickOutUserResultModel'    ];
...
'model' => 'getModel'    ];
     ...
     * Gets model
     *
     * @return \Yjopenapi\Client\Model\InteractiveKickOutUserResultModel
     */
     ...
     * Sets model
     *
     * @param \Yjopenapi\Client\Model\InteractiveKickOutUserResultModel $model model
     *
     * @return $this
     */
