...
/**
 * InteractiveModifySeatsFormsModifySeats Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class InteractiveModifySeatsFormsModifySeats implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'InteractiveModifySeatsFormsModifySeats';
