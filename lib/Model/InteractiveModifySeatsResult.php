...
/**
 * InteractiveModifySeatsResult Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class InteractiveModifySeatsResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'InteractiveModifySeatsResult';
    ...
    protected static $serialTypes = [
        'msg_code' => 'string',
'msg_info' => 'string',
'model' => '\Yjopenapi\Client\Model\InteractiveModifySeatsResultModel'    ];
...
'model' => 'getModel'    ];
     ...
     * Gets model
     *
     * @return \Yjopenapi\Client\Model\InteractiveModifySeatsResultModel
     */
     ...
     * Sets model
     *
     * @param \Yjopenapi\Client\Model\InteractiveModifySeatsResultModel $model model
     *
     * @return $this
     */
