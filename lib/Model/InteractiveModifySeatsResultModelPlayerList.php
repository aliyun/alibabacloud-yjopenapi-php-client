...
/**
 * InteractiveModifySeatsResultModelPlayerList Class Doc Comment
 *
 * @category Class
 * @description 派对Id
 * @package  Yjopenapi\Client
 */
class InteractiveModifySeatsResultModelPlayerList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'InteractiveModifySeatsResultModelPlayerList';
