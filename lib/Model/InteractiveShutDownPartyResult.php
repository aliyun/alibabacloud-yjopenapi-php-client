...
/**
 * InteractiveShutDownPartyResult Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class InteractiveShutDownPartyResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'InteractiveShutDownPartyResult';
