...
/**
 * LiveQueryStatusForms Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class LiveQueryStatusForms implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'LiveQueryStatusForms';
