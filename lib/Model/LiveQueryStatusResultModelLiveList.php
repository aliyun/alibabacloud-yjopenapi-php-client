...
'message' => 'string',
'live_id' => 'string',
'config' => '\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Model\LiveQueryStatusResultModelLiveListConfig',
'status' => 'string'    ];
...
'status' => 'getStatus'    ];
     ...
     * Gets config
     *
     * @return \Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Model\LiveQueryStatusResultModelLiveListConfig
     */
     ...
     * Sets config
     *
     * @param \Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Model\LiveQueryStatusResultModelLiveListConfig $config config
     *
     * @return $this
     */
