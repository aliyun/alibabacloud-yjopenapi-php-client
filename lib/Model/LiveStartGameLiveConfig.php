...
/**
 * LiveStartGameLiveConfig Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class LiveStartGameLiveConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'LiveStartGameLiveConfig';
