...
'server_url' => 'string',
'stream_key' => 'string',
'config' => '\Yjopenapi\Client\Model\LiveStartGameLiveFormsConfig'    ];
...
'config' => 'getConfig'    ];
     ...
     * Gets config
     *
     * @return \Yjopenapi\Client\Model\LiveStartGameLiveFormsConfig
     */
     ...
     * Sets config
     *
     * @param \Yjopenapi\Client\Model\LiveStartGameLiveFormsConfig $config config
     *
     * @return $this
     */
