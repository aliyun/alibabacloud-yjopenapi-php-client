...
/**
 * MultiplayDemoModifyMultiPlayForms Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class MultiplayDemoModifyMultiPlayForms implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'MultiplayDemoModifyMultiPlayForms';
