...
/**
 * MultiplayDemoQueryMultiPlayResultModelConfig Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class MultiplayDemoQueryMultiPlayResultModelConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'MultiplayDemoQueryMultiPlayResultModelConfig';
...
'offline_timeout' => 'setOfflineTimeout',
'forbid_join' => 'setForbidJoin',
...
'offline_timeout' => 'getOfflineTimeout',
'forbid_join' => 'getForbidJoin',
...
'input_timeout' => 'getInputTimeout'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['offline_timeout'] = isset($data['offline_timeout']) ? $data['offline_timeout'] : null;
        $this->container['forbid_join'] = isset($data['forbid_join']) ? $data['forbid_join'] : null;
    ...
    /**
     * Gets offline_timeout
     *
     * @return int
     */
    public function getOfflineTimeout()
    {
        return $this->container['offline_timeout'];
    }

    /**
     * Sets offline_timeout
     *
     * @param int $offline_timeout offline_timeout
     *
     * @return $this
     */
    public function setOfflineTimeout($offline_timeout)
    {
        $this->container['offline_timeout'] = $offline_timeout;
     ...
     * @return bool
     */
    public function getForbidJoin()
    {
        return $this->container['forbid_join'];
    }

    /**
     * Sets forbid_join
     *
     * @param bool $forbid_join forbid_join
     *
     * @return $this
     */
    public function setForbidJoin($forbid_join)
    {
        $this->container['forbid_join'] = $forbid_join;
