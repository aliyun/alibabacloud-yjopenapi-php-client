...
class MultiplayInitForms implements ModelInterface, ArrayAccess
{
    ...
    protected static $serialTypes = [
        'game_session' => 'string',
'app_key' => 'string',
'config' => '\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayInitFormsConfig',
'tokens' => '\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayInitFormsTokens[]'    ];
...
'tokens' => 'getTokens'    ];
     ...
     * Gets config
     *
     * @return \Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayInitFormsConfig
     */
     ...
     * Sets config
     *
     * @param \Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayInitFormsConfig $config config
     *
     * @return $this
     */
     ...
     * Gets tokens
     *
     * @return \Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayInitFormsTokens[]
     */
     ...
     * Sets tokens
     *
     * @param \Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Yjopenapi\Client\Model\MultiplayInitFormsTokens[] $tokens tokens
     *
     * @return $this
     */
