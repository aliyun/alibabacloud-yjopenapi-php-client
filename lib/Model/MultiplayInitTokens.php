...
/**
 * MultiplayInitTokens Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class MultiplayInitTokens implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'MultiplayInitTokens';
