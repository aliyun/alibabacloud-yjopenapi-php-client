...
class SetGameAliveResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $serialTypes = [
        'success' => 'bool',
'model' => '\Yjopenapi\Client\Model\SetGameAliveResultModel',
'msg_info' => 'string',
'msg_code' => 'string'    ];
...
'msg_code' => 'getMsgCode'    ];
     ...
     * Gets model
     *
     * @return \Yjopenapi\Client\Model\SetGameAliveResultModel
     */
     ...
     * Sets model
     *
     * @param \Yjopenapi\Client\Model\SetGameAliveResultModel $model model
     *
     * @return $this
     */
