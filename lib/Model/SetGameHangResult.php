...
class SetGameHangResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $serialTypes = [
        'success' => 'bool',
'model' => '\Yjopenapi\Client\Model\SetGameHangResultModel',
'msg_info' => 'string',
'msg_code' => 'string'    ];
...
'msg_code' => 'getMsgCode'    ];
     ...
     * Gets model
     *
     * @return \Yjopenapi\Client\Model\SetGameHangResultModel
     */
     ...
     * Sets model
     *
     * @param \Yjopenapi\Client\Model\SetGameHangResultModel $model model
     *
     * @return $this
     */
