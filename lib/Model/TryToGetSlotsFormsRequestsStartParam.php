...
/**
 * TryToGetSlotsFormsRequestsStartParam Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class TryToGetSlotsFormsRequestsStartParam implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'TryToGetSlotsFormsRequestsStartParam';
...
'device_brand' => 'getDeviceBrand'    ];
     ...
     *
     * @param string $schedule_user_levels schedule_user_levels
     *
     * @return $this
     */
