...
/**
 * UsercontollerDeleteGameArchiveResult Class Doc Comment
 *
 * @category Class
 * @package  Yjopenapi\Client
 */
class UsercontollerDeleteGameArchiveResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $serialModelName = 'UsercontollerDeleteGameArchiveResult';
...
'msg_info' => 'string',
'success' => 'bool',
'model' => '\Yjopenapi\Client\Model\UsercontollerDeleteGameArchiveResultModel'    ];
...
'model' => 'getModel'    ];
     ...
     * Gets model
     *
     * @return \Yjopenapi\Client\Model\UsercontollerDeleteGameArchiveResultModel
     */
     ...
     * Sets model
     *
     * @param \Yjopenapi\Client\Model\UsercontollerDeleteGameArchiveResultModel $model model
     *
     * @return $this
     */
