...
class UsercontrollerGetUserGameArchiveResultModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $serialTypes = [
        'user_game_archive_dto' => '\Yjopenapi\Client\Model\UsercontrollerGetUserGameArchiveResultModelUserGameArchiveDTO',
'download_url' => 'string',
'object_md5' => 'string'    ];
...
'object_md5' => 'getObjectMd5'    ];
     ...
     *
     * @return \Yjopenapi\Client\Model\UsercontrollerGetUserGameArchiveResultModelUserGameArchiveDTO
     */
     ...
     *
     * @param \Yjopenapi\Client\Model\UsercontrollerGetUserGameArchiveResultModelUserGameArchiveDTO $user_game_archive_dto user_game_archive_dto
     *
     * @return $this
     */
